...
class User extends Base
{
    ...
    public function changelevel(){
        ...
        if(IS_POST){
            ...
            $res = M('users')->where(['user_id'=>$post['user_id']])->update(['level'=>$post['level'],'balance_leader'=>$balance_leader,'third_leader'=>$third_leader]);
            if($res){
     ...
     public function detail()
     {
         ...
         if (IS_POST) {
            ...
            //  }
             ...
             $_POST['balance_leader'] = findbalance_leader($uid,$user['level']);
             $_POST['third_leader'] = findthird_leader($uid,$user['level']);
